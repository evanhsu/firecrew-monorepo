...
export type GetBoardByGroupQuery = {
    __typename?: 'Query';
    getBoardByGroup: Array<{
        __typename: 'Board';
        id: string;
        name?: string | null;
...
export type WatchBoardSubscription = {
    __typename?: 'Subscription';
    watchBoard: {
        __typename: 'Board';
        id: string;
...
export type BoardPartsFragment = {
    __typename: 'Board';
    id: string;
    name?: string | null;
    group?: { __typename: 'Group'; id?: string | null } | null;
...
export type BoardStatePartsFragment = {
    __typename: 'BoardState';
    id: string;
    revision: number;
    createdAt: any;
...
export type CreateAndAddPersonToBoardMutation = {
    __typename?: 'Mutation';
...
export type AddExistingPersonToBoardMutation = {
    __typename?: 'Mutation';
 ...
 * });
 */
export function useGetBoardByGroupQuery(
    baseOptions: Apollo.QueryHookOptions<
        GetBoardByGroupQuery,
        GetBoardByGroupQueryVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useQuery<GetBoardByGroupQuery, GetBoardByGroupQueryVariables>(
        GetBoardByGroupDocument,
        options
    );
}
export function useGetBoardByGroupLazyQuery(
    ...
    return Apollo.useLazyQuery<
        GetBoardByGroupQuery,
        GetBoardByGroupQueryVariables
    >(GetBoardByGroupDocument, options);
}
export type GetBoardByGroupQueryHookResult = ReturnType<
    typeof useGetBoardByGroupQuery
>;
export type GetBoardByGroupLazyQueryHookResult = ReturnType<
    typeof useGetBoardByGroupLazyQuery
>;
export type GetBoardByGroupQueryResult = Apollo.QueryResult<
    GetBoardByGroupQuery,
    GetBoardByGroupQueryVariables
>;
 ...
 * });
 */
export function useWatchBoardSubscription(
    baseOptions: Apollo.SubscriptionHookOptions<
        WatchBoardSubscription,
        WatchBoardSubscriptionVariables
    >
) {
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useSubscription<
        WatchBoardSubscription,
        WatchBoardSubscriptionVariables
    >(WatchBoardDocument, options);
}
export type WatchBoardSubscriptionHookResult = ReturnType<
    typeof useWatchBoardSubscription
>;
export type WatchBoardSubscriptionResult =
    Apollo.SubscriptionResult<WatchBoardSubscription>;
export const MoveTileDocument = gql`
    ...
    ${BoardStatePartsFragmentDoc}
`;
export type MoveTileMutationFn = Apollo.MutationFunction<
    MoveTileMutation,
 ...
 * });
 */
export function useMoveTileMutation(
    ...
    const options = { ...defaultOptions, ...baseOptions };
    return Apollo.useMutation<MoveTileMutation, MoveTileMutationVariables>(
        MoveTileDocument,
        options
    );
}
...
export type MoveTileMutationOptions = Apollo.BaseMutationOptions<
    MoveTileMutation,
    MoveTileMutationVariables
>;
...
export const CreateAndAddPersonToBoardDocument = gql`
    mutation CreateAndAddPersonToBoard(
        $person: CreatePersonInput!
        $boardId: ID!
    ) {
    ...
    ${BoardStatePartsFragmentDoc}
`;
export type CreateAndAddPersonToBoardMutationFn = Apollo.MutationFunction<
    CreateAndAddPersonToBoardMutation,
    CreateAndAddPersonToBoardMutationVariables
>;
 ...
 * });
 */
export function useCreateAndAddPersonToBoardMutation(
    baseOptions?: Apollo.MutationHookOptions<
        CreateAndAddPersonToBoardMutation,
        CreateAndAddPersonToBoardMutationVariables
    >
    ...
    return Apollo.useMutation<
        CreateAndAddPersonToBoardMutation,
        CreateAndAddPersonToBoardMutationVariables
    >(CreateAndAddPersonToBoardDocument, options);
}
export type CreateAndAddPersonToBoardMutationHookResult = ReturnType<
    typeof useCreateAndAddPersonToBoardMutation
>;
export type CreateAndAddPersonToBoardMutationResult =
    Apollo.MutationResult<CreateAndAddPersonToBoardMutation>;
export type CreateAndAddPersonToBoardMutationOptions =
...
export const AddExistingPersonToBoardDocument = gql`
    ...
    ${BoardStatePartsFragmentDoc}
`;
export type AddExistingPersonToBoardMutationFn = Apollo.MutationFunction<
    AddExistingPersonToBoardMutation,
    AddExistingPersonToBoardMutationVariables
>;
 ...
 * });
 */
export function useAddExistingPersonToBoardMutation(
    baseOptions?: Apollo.MutationHookOptions<
        AddExistingPersonToBoardMutation,
        AddExistingPersonToBoardMutationVariables
    >
    ...
    return Apollo.useMutation<
        AddExistingPersonToBoardMutation,
        AddExistingPersonToBoardMutationVariables
    >(AddExistingPersonToBoardDocument, options);
}
export type AddExistingPersonToBoardMutationHookResult = ReturnType<
    typeof useAddExistingPersonToBoardMutation
>;
export type AddExistingPersonToBoardMutationResult =
    Apollo.MutationResult<AddExistingPersonToBoardMutation>;
export type AddExistingPersonToBoardMutationOptions =
    Apollo.BaseMutationOptions<
        AddExistingPersonToBoardMutation,
        AddExistingPersonToBoardMutationVariables
    >;
