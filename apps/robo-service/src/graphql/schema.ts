...
export const schema = makeSchema({
    ...
    outputs: {
        ...
        typegen: join(
            monorepoRoot,
            'apps/robo-service/generated/nexus-typegen.ts'
        ),
        ...
        schema: join(
            monorepoRoot,
            'apps/robo-service/generated/schema.graphql'
        ),
    },
    contextType: {
        ...
        modules: [
            {
                ...
                module: join(
                    monorepoRoot,
                    'apps/robo-service/src/database/db.ts'
                ),
            ...
            },
            {
                module: join(
                    monorepoRoot,
                    'apps/robo-service/src/errors/errors.ts'
                ),
                alias: 'errors',
